...
//* querySelectorAll gibi davranır, çoklu seçim yapar eğer fazla varsa ve dizi/nodlist benzeri bir yapı döndürür.
//? const formJquery = jQuery("div") mesela

//? jquery de tanımlamalar kısa olduğu için çok fazla eleman seçip değişkene atama kullanılmaz
//? direk seçim yapılıp kullanılır çoğu zaman
const formJquery = $("form").eq(0); // ilk indisi aldık
...
//! basic ajax yapısı, içini düzenleyip kullanıyoruz.
    // $.ajax({
    //   type: "GET",
    //   url: url,
    //   dataType: "json",
